...
<head>
    ...
    <style>
        ...
        /* === KODE CSS DARK MODE YANG SUDAH DIPERBAIKI TOTAL === */
        ...
        html.dark-mode .table-scroll-container { border: 1px solid var(--dark-surface-2); border-radius: .375rem; }
        ...
        html.dark-mode .table b, html.dark-mode .table strong { color: var(--dark-text-primary); } /* Membuat text bold lebih terang */

        html.dark-mode .alert-success { background-color: #051b11; color: #75b798; border-color: #0f5132; }
        html.dark-mode .btn-close { filter: invert(1) grayscale(100) brightness(200%); }

        @media (max-width: 992px) { /* (Tidak ada perubahan) */ }
    </style>
</head>
<body>
